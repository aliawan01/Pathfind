...
class Grid:
    ...
    def draw_rect_nodes(self, algorithm, rect_array, start_node_color, end_node_color, marked_node_color):
    ...
    def mark_rect_node(self, rect_array, mouse_coords):
        for row in rect_array:
            for node in row:
    ...
    def unmark_rect_node(self, rect_array, mouse_coords):
        for row in rect_array:
            for node in row:
                if node.rect.collidepoint(mouse_coords):
                    node.marked = False
    ...
    def mark_start_node(self, rect_array, mouse_coords):
    ...
    def mark_end_node(self, rect_array, mouse_coords):
    ...
    def reset_marked_nodes(self, rect_array):
        for row in rect_array:
            for node in row:
                node.marked = False
